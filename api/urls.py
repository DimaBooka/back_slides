...
from api.views import FacebookLogin, GoogleLogin, PasswordReset, SlidesRegisterView
...
urlpatterns = [
    ...
    url(r'^rest-auth/registration/$', SlidesRegisterView.as_view(), name='rest_register'),
